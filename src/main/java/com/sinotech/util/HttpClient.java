...
//		requestConfig = RequestConfig.custom().setSocketTimeout(50000).setConnectTimeout(50000).setConnectionRequestTimeout(50000).build();
	 ...
	 * @throws Exception 
	 */
	private static String sendHttpPost(HttpPost httpPost, String authorization) throws Exception {
...
//			e.printStackTrace();
	 ...
	 * @throws Exception 
	 */
	public static String sendHttpPost(String httpUrl, String authorization) throws Exception {
		// 创建httpPost
...
//			e.printStackTrace();
	...
	public static String sendHttpPostJson(String httpUrl, String paramsJson, String authorization) throws Exception {
		HttpPost httpPost = new HttpPost(httpUrl);// 创建httpPost
		try {
			// 设置参数
			if (paramsJson != null && paramsJson.trim().length() > 0) {
